import{az as L}from"./index-D2VA4oRO.js";import{b as O,w as M}from"./math-CpLPzBb1.js";import{N as x,S as y,b as S,C as _,c as b,a as j,d as N}from"./BaseVector-BrfguNQS.js";import{o as T,p as C,s as v,q as Z,e as s,a as I,c as G,b as W,n as B,r as U,t as q,g as R,G as H,F as J}from"./compileUtil-C7myM2x8.js";function V(){return{"fill-color":"rgba(255,255,255,0.4)","stroke-color":"#3399CC","stroke-width":1.25,"circle-radius":5,"circle-fill-color":"rgba(255,255,255,0.4)","circle-stroke-width":1.25,"circle-stroke-color":"#3399CC"}}const z=.985,P=`#ifdef GL_FRAGMENT_PRECISION_HIGH
...
}`,w(e,t,n,"shape-");let i=null;"shape-opacity"in e&&(i=s(n,e["shape-opacity"],x));let o="coordsPx";"shape-scale"in e&&(o=`coordsPx / ${s(n,e["shape-scale"],y)}`);let f=null;"shape-fill-color"in e&&(f=s(n,e["shape-fill-color"],_));let l=null;"shape-stroke-color"in e&&(l=s(n,e["shape-stroke-color"],_));let a=null;"shape-stroke-width"in e&&(a=s(n,e["shape-stroke-width"],x));const c=s(n,e["shape-points"],x);let u="0.";"shape-angle"in e&&(u=s(n,e["shape-angle"],x));let h,g=s(n,e["shape-radius"],x);if(a!==null&&(g=`${g} + ${a} * 0.5`),"shape-radius2"in e){let p=s(n,e["shape-radius2"],x);a!==null&&(p=`${p} + ${a} * 0.5`),h=`starDistanceField(${o}, ${c}, ${g}, ${p}, ${u})`}else h=`regularDistanceField(${o}, ${c}, ${g}, ${u})`;const m=D(h,f,l,a,i);t.setSymbolColorExpression(m)}function Q(e,t,r,n){let i="vec4(1.0)";"icon-color"in e&&(i=s(n,e["icon-color"],_)),"icon-opacity"in e&&(i=`${i} * vec4(1.0, 1.0, 1.0, ${s(n,e["icon-opacity"],x)})`);const o=F(e["icon-src"]),f=k(e,t,r,"icon-",o);if(t.setSymbolColorExpression(`${i} * texture2D(u_texture${o}, v_texCoord)`).setSymbolSizeExpression(f),"icon-width"in e&&"icon-height"in e&&t.setSymbolSizeExpression(`vec2(${s(n,e["icon-width"],x)}, ${s(n,e["icon-height"],x)})`),"icon-offset"in e&&"icon-size"in e){const l=s(n,e["icon-size"],S),a=t.getSymbolSizeExpression();t.setSymbolSizeExpression(l);const c=A(e,"icon-",n,"v_quadSizePx",l);t.setTextureCoordinateExpression(`(vec4((${c}).xyxy) + vec4(0., 0., ${l})) / (${a}).xyxy`)}if(w(e,t,n,"icon-"),"icon-anchor"in e){const l=s(n,e["icon-anchor"],S);let a="1.0";"icon-scale"in e&&(a=s(n,e["icon-scale"],y));let c;e["icon-anchor-x-units"]==="pixels"&&e["icon-anchor-y-units"]==="pixels"?c=`${l} * ${a}`:e["icon-anchor-x-units"]==="pixels"?c=`${l} * vec2(vec2(${a}).x, v_quadSizePx.y)`:e["icon-anchor-y-units"]==="pixels"?c=`${l} * vec2(v_quadSizePx.x, vec2(${a}).x)`:c=`${l} * v_quadSizePx`;let u=`v_quadSizePx * vec2(0.5, -0.5) + ${c} * vec2(-1., 1.)`;if("icon-anchor-origin"in e)switch(e["icon-anchor-origin"]){case"top-right":u=`v_quadSizePx * -0.5 + ${c}`;break;case"bottom-left":u=`v_quadSizePx * 0.5 - ${c}`;break;case"bottom-right":u=`v_quadSizePx * vec2(-0.5, 0.5) + ${c} * vec2(1., -1.)`;break}t.setSymbolOffsetExpression(`${t.getSymbolOffsetExpression()} + ${u}`)}}function tt(e,t,r,n){if("stroke-color"in e&&t.setStrokeColorExpression(s(n,e["stroke-color"],_)),"stroke-pattern-src"in e){const i=F(e["stroke-pattern-src"]),o=k(e,t,r,"stroke-pattern-",i);let f=o,l="vec2(0.)";"stroke-pattern-offset"in e&&"stroke-pattern-size"in e&&(f=s(n,e["stroke-pattern-size"],S),l=A(e,"stroke-pattern-",n,o,f));let a="0.";"stroke-pattern-spacing"in e&&(a=s(n,e["stroke-pattern-spacing"],x));let c="0.";"stroke-pattern-start-offset"in e&&(c=s(n,e["stroke-pattern-start-offset"],x)),n.functions.sampleStrokePattern=`vec4 sampleStrokePattern(sampler2D texture, vec2 textureSize, vec2 textureOffset, vec2 sampleSize, float spacingPx, float startOffsetPx, float currentLengthPx, float currentRadiusRatio, float lineWidth) {
...
}`;const a=`u_texture${i}`;let c="1.";"fill-color"in e&&(c=t.getFillColorExpression()),t.setFillColorExpression(`${c} * sampleFillPattern(${a}, ${o}, ${l}, ${f}, pxOrigin, pxPos)`)}}function ft(e,t,r){const n=B(),i=new Y,o={};if("icon-src"in e?Q(e,i,o,n):"shape-points"in e?X(e,i,o,n):"circle-radius"in e&&K(e,i,o,n),tt(e,i,o,n),et(e,i,o,n),r){const a=s(n,r,j);i.setFragmentDiscardExpression(`!${a}`)}const f={};function l(a,c,u,h){if(!n[a])return;const g=U(u),m=q(u);i.addAttribute(`a_${c}`,g),f[c]={size:m,callback:h}}return l("geometryType",H,b,a=>R(N(a.getGeometry()))),l("featureId",J,b|x,a=>{const c=a.getId()??null;return typeof c=="string"?R(c):c}),I(i,n),{builder:i,attributes:{...f,...W(n)},uniforms:{...o,...G(n,t)}}}const d=new Uint8Array(4);class xt{constructor(t,r){this.helper_=t;const n=t.getGL();this.texture_=n.createTexture(),this.framebuffer_=n.createFramebuffer(),this.depthbuffer_=n.createRenderbuffer(),this.size_=r||[1,1],this.data_=new Uint8Array(0),this.dataCacheDirty_=!0,this.updateSize_()}setSize(t){M(t,this.size_)||(this.size_[0]=t[0],this.size_[1]=t[1],this.updateSize_())}getSize(){return this.size_}clearCachedData(){this.dataCacheDirty_=!0}readAll(){if(this.dataCacheDirty_){const t=this.size_,r=this.helper_.getGL();r.bindFramebuffer(r.FRAMEBUFFER,this.framebuffer_),r.readPixels(0,0,t[0],t[1],r.RGBA,r.UNSIGNED_BYTE,this.data_),this.dataCacheDirty_=!1}return this.data_}readPixel(t,r){if(t<0||r<0||t>this.size_[0]||r>=this.size_[1])return d[0]=0,d[1]=0,d[2]=0,d[3]=0,d;this.readAll();const n=Math.floor(t)+(this.size_[1]-Math.floor(r)-1)*this.size_[0];return d[0]=this.data_[n*4],d[1]=this.data_[n*4+1],d[2]=this.data_[n*4+2],d[3]=this.data_[n*4+3],d}getTexture(){return this.texture_}getFramebuffer(){return this.framebuffer_}getDepthbuffer(){return this.depthbuffer_}updateSize_(){const t=this.size_,r=this.helper_.getGL();this.texture_=this.helper_.createTexture(t,null,this.texture_),r.bindFramebuffer(r.FRAMEBUFFER,this.framebuffer_),r.viewport(0,0,t[0],t[1]),r.framebufferTexture2D(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,this.texture_,0),r.bindRenderbuffer(r.RENDERBUFFER,this.depthbuffer_),r.renderbufferStorage(r.RENDERBUFFER,r.DEPTH_COMPONENT16,t[0],t[1]),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.DEPTH_ATTACHMENT,r.RENDERBUFFER,this.depthbuffer_),this.data_=new Uint8Array(t[0]*t[1]*4)}}export{Y as S,xt as W,st as a,at as b,ct as c,lt as d,ft as p};
//# sourceMappingURL=RenderTarget-DMlouAoY.js.map
