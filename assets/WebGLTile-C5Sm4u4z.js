import{C as R,N as f}from"./BaseVector-BrfguNQS.js";import{W as v,e as d,u as S,U as r,P as b,A as g,n as $,g as C}from"./compileUtil-C7myM2x8.js";import{L as x}from"./Event-DDT0sWw7.js";import I from"./BaseTile-CfGGzka9.js";import"./index-jYV8uuws.js";import"./color-b0HL0oeC.js";import"./Image-CUFz0Zy0.js";import"./math-CpLPzBb1.js";import"./style-BzRw5JKv.js";import"./TileState-DENk7BAX.js";import"./contains-y9KzPzWu.js";import"./mat4-CeypvY8Z.js";import"./DataTile-ipTFvjtE.js";import"./Tile-D8jlKUOE.js";import"./common-DCCTrzDZ.js";import"./Tile-Bcx2Gg4x.js";import"./common-DLpPUfHB.js";import"./TileRange-2Tc-Ry00.js";import"./LRUCache-CNVz6SF2.js";import"./tilecoord-CAZNhSrv.js";import"./Layer-BLlj3czp.js";import"./View-CrdVYwSL.js";import"./Polygon-DC42eu6N.js";import"./orient-b1H3_74v.js";import"./intersectsextent-BlTQmHkM.js";import"./TileProperty-BF4LcWSy.js";function T(s,e){const n=`
  ...
  `,t={...$(),bandCount:e},i=[];if(s.color!==void 0){const o=d(t,s.color,R);i.push(`color = ${o};`)}if(s.contrast!==void 0){const o=d(t,s.contrast,f);i.push(`color.rgb = clamp((${o} + 1.0) * color.rgb - (${o} / 2.0), vec3(0.0, 0.0, 0.0), vec3(1.0, 1.0, 1.0));`)}if(s.exposure!==void 0){const o=d(t,s.exposure,f);i.push(`color.rgb = clamp((${o} + 1.0) * color.rgb, vec3(0.0, 0.0, 0.0), vec3(1.0, 1.0, 1.0));`)}if(s.saturation!==void 0){const o=d(t,s.saturation,f);i.push(`
    ...
    `)}if(s.gamma!==void 0){const o=d(t,s.gamma,f);i.push(`color.rgb = pow(color.rgb, vec3(1.0 / ${o}));`)}if(s.brightness!==void 0){const o=d(t,s.brightness,f);i.push(`color.rgb = clamp(color.rgb + ${o}, vec3(0.0, 0.0, 0.0), vec3(1.0, 1.0, 1.0));`)}const a={},c=Object.keys(t.variables).length;if(c>1&&!s.variables)throw new Error(`Missing variables in style (expected ${t.variables})`);for(let o=0;o<c;++o){const _=t.variables[Object.keys(t.variables)[o]];if(!(_.name in s.variables))throw new Error(`Missing '${_.name}' in style variables`);const p=S(_.name);a[p]=function(){let m=s.variables[_.name];return typeof m=="string"&&(m=C(m)),m!==void 0?m:-9999999}}const u=Object.keys(a).map(function(o){return`uniform float ${o};`}),h=Math.ceil(e/4);u.push(`uniform sampler2D ${r.TILE_TEXTURE_ARRAY}[${h}];`),t.paletteTextures&&u.push(`uniform sampler2D ${b}[${t.paletteTextures.length}];`);const l=Object.keys(t.functions).map(function(o){return t.functions[o]}),E=`
